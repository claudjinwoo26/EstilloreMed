<?php
    ...
    $sortColumn = isset($_GET['sort']) ? $_GET['sort'] : 'medicine_id';
    ...
    $query = "SELECT medicines.*,
        ...
        END AS 'category'
        FROM medicines
        WHERE quantity <= stock_alert OR exp_date <= NOW()
    ...
    <header class="header home-bg" id="header" style="opacity:; height: 69px;">
        <div class="w-20 h-20">
            ...
            style="text-decoration:none; color: black; opacity:.8; width:100px;"><i class='bx bx-left-arrow'></i>
                Inventory</a>
            <p class="mr-5 float text-center" style="text-decoration:none; color: black;">MEDICINE TABLE</p>
        </div>
    </header>
    <div class="">
        <div>
            <table class="table">
                <tr class="bg-info text-dark table-head">
