...
<html lang="en">
    <head>
        ...
        <title>Home - Estillore Medical Clinic</title>
    ...
    <body>
        <div class="col-md-5 bg-white float-left" style="height: 100vh; overflow-y: auto;">
            <form class="mx-auto form p-5 d-flex flex-column justify-content-center align-items-center">
                <div class="col-md-12">
                    <h1 class="font-weight-light" style="color: rgb(0, 0, 77); text-align: center; font-size: 50px;">_______________</h1>
                    <br><br><br><br><br>
                    <a href="login.php" target="_blank" rel="noopener noreferrer"><button type="button" class="btn btn-primary rounded col-md-12">Log In</button></a>
                    <br><br>
                    <a href="signup.php" target="_blank" rel="noopener noreferrer"><button type="button" class="btn btn-primary rounded col-md-12">Sign Up</button></a>
                </div>
            </form>
        </div>
